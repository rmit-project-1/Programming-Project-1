...
<br>
  ...
  $q = "SELECT * FROM fleet WHERE (location ='".$location."' AND tier ='".$tier."' AND booked ='".false."')";
    ...
    print"<tr>";
      print"<td>";
      print"<img class='card-img-top' src='http://mcm.mccrew.com.au/$valueImg' alt='Card image cap'>";
      print"</td>";
      print"<td>";
        ...
        print"<a href='remove_process.php?id=$valueId' class='btn btn-danger'>Remove</a>";
      print"</td>";
      print"</tr>";
